...
def main():
    ...
    baseUp = baseArrow(1115 - valx, val,"up")
    baseDown = baseArrow(570 - valx, val,"down")
    baseLeft = baseArrow(375 - valx, val,"left")
    baseRight = baseArrow(1305 - valx, val,"right")
    baseCenter = baseArrow(765 - valx, val,"center")
    baseBlink = baseArrow(945 - valx, val,"blink")
